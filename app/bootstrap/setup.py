...
# v0.30.0 (2026-08-03): MiniMax-H3 ネイティブ対応（scom-v の前提バージョン）。
COMFYUI_REF = os.environ.get("SCOM_COMFYUI_REF", "v0.30.0")
...
COMFYUI_MARKER = os.environ.get("SCOM_COMFYUI_MARKER", "v0.30.0")
